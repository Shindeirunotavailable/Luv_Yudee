                    ...
                    <div class="navtab-style1">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab2" role="tablist">
                                    <button id="" class="nav-link-ap {{ !isset($data['property']->submit) || $data['property']->submit=='1' ? 'active' : '' }} font-weight-600 ml-3" id="nav-description-tab"
                                        data-toggle="tab" data-target="#nav-description" type="button" role="tab"
                                        aria-controls="nav-description" aria-selected="{{ isset($data['property']->submit) && $data['property']->submit=='1' ? 'true' : 'false' }}">
                                        1. Description
                                    </button>
                                    <button class="nav-link-ap {{ isset($data['property']->submit) && $data['property']->submit=='2' ? 'active' : '' }} font-weight-600" id="nav-media-tab" data-toggle="tab"
                                        data-target="#nav-media" type="button" role="tab" aria-controls="nav-media"
                                        aria-selected="{{ isset($data['property']->submit) && $data['property']->submit=='2' ? 'true' : 'false' }}">2. Media
                                    </button>
                                    <button class="nav-link-ap {{ isset($data['property']->submit) && $data['property']->submit=='3' ? 'active' : '' }} font-weight-600" id="nav-location-tab" data-toggle="tab"
                                        data-target="#nav-location" type="button" role="tab" aria-controls="nav-location"
                                        aria-selected="{{ isset($data['property']->submit) && $data['property']->submit=='3' ? 'true' : 'false' }}">3. Location
                                    </button>
                                    <button class="nav-link-ap {{ isset($data['property']->submit) && $data['property']->submit=='4' ? 'active' : '' }} font-weight-600" id="nav-detail-tab" data-toggle="tab"
                                        data-target="#nav-detail" type="button" role="tab" aria-controls="nav-detail"
                                        aria-selected="{{ isset($data['property']->submit) && $data['property']->submit=='4' ? 'true' : 'false' }}">4. Detail
                                    </button>
                                    <button class="nav-link-ap {{ isset($data['property']->submit) && $data['property']->submit=='5' ? 'active' : '' }} font-weight-600" id="nav-amenities-tab" data-toggle="tab"
                                        data-target="#nav-amenities" type="button" role="tab" aria-controls="nav-amenities"
                                        aria-selected="{{ isset($data['property']->submit) && $data['property']->submit=='5' ? 'true' : 'false' }}">5. Amenities
                                    </button>
                                </div>
                            </nav>
                        ...
                        <form method="POST" action="{{ route('properties') }}" enctype="multipart/form-data">
                            ...
                            <div class="tab-content-ds" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade {{ !isset($data['property']->submit) || $data['property']->submit=='1' ? 'show active' : '' }}" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                        <div class="ps-widget bg-white bdrs-12 p-d-30 overflow-hidden position-relative">
                                            @if($message = Session::get('success') && $data['property']->submit=='1')
                                            ...
                                            <button data-target="#nav-media-tab" type="submit" id="submitdescription" class="afterButton rounded-pill btn-lg mt-2 float-right" name="submit" value="1">Submit</button>
                                        </div>
                                </div>

                                <div class="tab-pane fade {{ isset($data['property']->submit) && $data['property']->submit=='2' ? 'show active' : '' }}" id="nav-media" role="tabpanel" aria-labelledby="nav-media-tab">
                                        <div class="ps-widget bg-white bdrs-12 p-d-30 overflow-hidden position-relative">
                                            @if($message = Session::get('success') && $data['property']->submit=='2')
                                                <div class="alert alert-success alert-block">
                                            ...
                                            <button type="submit" id="submitmedia" class="afterButton rounded-pill btn-lg mt-2 float-right " name="submit" value="2">Submit</button>
                                        </div>
                                </div>

                                <div class="tab-pane fade{{ isset($data['property']->submit) && $data['property']->submit=='3' ? 'show active' : '' }}" id="nav-location" role="tabpanel" aria-labelledby="nav-location-tab">
                                        <div class="ps-widget bg-white bdrs-12 p-d-30 overflow-hidden position-relative">
                                            @if($message = Session::get('success') && $data['property']->submit=='3')
                                                <div class="alert alert-success alert-block">
                                            ...
                                            <h4 class="fw-600 title fs-17 mb-6">Listing Location</h4>
                                                ...
                                                <button type="submit" name="submit" value="3" id="submitdetail" class="afterButton rounded-pill btn-lg mt-2 float-right">Submit</button>
                                        </div>
                                </div>

                                <div class="tab-pane fade{{ isset($data['property']->submit) && $data['property']->submit=='4' ? 'show active' : '' }}" id="nav-detail" role="tabpanel" aria-labelledby="nav-detail-tab">
                                    <div class="ps-widget bg-white bdrs-12 p-d-30 overflow-hidden position-relative">
                                        @if($message = Session::get('success') && $data['property']->submit=='4')
                                                <div class="alert alert-success alert-block">
                                        ...
                                        <button type="submit" name="submit" value="4" id="submitlocation" class="afterButton rounded-pill btn-lg mt-2 float-right">Submit</button>
                                    </div>
                                </div>

                                <div class="tab-pane fade{{ isset($data['property']->submit) && $data['property']->submit=='5' ? 'show active' : '' }}" id="nav-amenities" role="tabpanel" aria-labelledby="nav-amenities-tab">
                                    <div class="ps-widget bg-white bdrs-12 p-d-30 overflow-hidden position-relative">
                                        @if($message = Session::get('success') && $data['property']->submit=='5')
                                                <div class="alert alert-success alert-block">
                                        ...
                                        <button type="submit" id="submitpp" name="submit" value="5" class="afterButton rounded-pill btn-lg mt-2 float-right">Submit</button>
                                    </div>
