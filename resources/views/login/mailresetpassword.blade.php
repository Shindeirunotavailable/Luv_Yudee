...
<body>
    ...
    <div class="container">
        ...
        <p class="pt-40">เราได้รับคำขอรีเซ็ตรหัสผ่านสำหรับบัญชีของคุณที่เชื่อมโยงกับอีเมลนี้ที่เราได้รับ
            โปรดคลิกที่ลิงก์ด้านล่างเพื่อกู้คืนบัญชีผู้ใช้งานของคุณ</p>
        <form action="{{ url('resetPassword') }}" method="GET">
            @csrf
            <input type="hidden" name="resetToken" value="{{ $resetToken }}">
            <button type="submit" class="reset-btn">รีเซ็ตรหัสผ่าน</button>
        </form>
        <p>หากคุณไม่ได้กำลังพยายามกู้คืนข้อมูลรับรองการเข้าสู่ระบบบัญชีของคุณ
            โปรดละเว้นอีเมลนี้ เป็นไปได้ว่า ผู้ใช้อื่นได้กรอกข้อมูลการเข้าสู่ระบบของตนไว้ไม่ถูกต้อง</p>
