    ...
    @section('content')
        ...
        <div class="container ">
            <div class="imagbackground container pt-30" >
                        ...
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Email" name="Email" id="Email" class="form-control" id="exampleInputEmail1" placeholder="Enter Username" required>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control" id="exampleInputEmail1" placeholder="Enter Password" required>
                                    <div class="invalid-feedback">
