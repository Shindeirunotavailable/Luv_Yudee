                ...
                <div class="pro-city-slider position-relative ">
                    <div
                        ...
                        <div class="swiper-wrapper transforms">
                            ...
                            <div class="swiper-slide swiper-slide-prev" style="width: 188.5px; margin-right: 15px;">
                                <div class="item">
                                    <div class="feature-st3 text-center">
                                        <div class="feature-img rounded-circle">
                            ...
                            <div class="swiper-slide swiper-slide-active" style="width: 188.5px; margin-right: 15px;">
                                <div class="item">
                                    <div class="feature-st3 text-center">
                                        <div class="feature-img rounded-circle">
