                    ...
                    <div class="inner-banner-st4">
                        ...
                        <div class="advance-search mt-60 mt30-lg mr-auto ml-auto animation-up-3">
                            <ul class="nav nav-tabs  p-0 m-0">
                                <li class="nav-items">
                                    <a class="nav-items nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-buy" aria-selected="true">Buy</a>
                                </li>
                                <li class="nav-items">
                                    <a class="nav-items nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-rent" aria-selected="false">Rent</a>
                                </li>
                                <li class="nav-items">
                                    <a class="nav-items nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-sold" aria-selected="false">Sold</a>
                                </li>
                            </ul>
                                                        ...
                                                        <div class="select-custom css-b62m3t-container">
                                                            ...
                                                            <div class="select__control css-13cymwt-control">
                                                                <div class="select__value-container select__value-container--has-value css-hlgwow">
                                                                    <div class="select__single-value css-1dimb5e-singleValue">Bungalow</div>
                                                                ...
                                                                <div class="select__indicators css-1wy0on6">
                                                                    ...
                                                                    <div class="select__indicator select__dropdown-indicator css-1xc3v61-indicatorContainer"aria-hidden="true"><svg height="20"width="20" viewBox="0 0 20 20"aria-hidden="true"focusable="false"class="css-8mmkcg">
                                                                            <path
                                                ...
                                                <div class="widget-wrapper">
                                                    ...
                                                    <div class="form-style2 input-group">
                                                        <div class="select-custom css-b62m3t-container">
                                                            ...
                                                            <div class="select__control css-13cymwt-control">
                                                                <div class="select__value-container select__value-container--has-value css-hlgwow">
                                                                    <div class="select__single-value css-1dimb5e-singleValue">All Cities</div>
                                                                    <div class="select__input-container css-19bb58m"data-value="">
