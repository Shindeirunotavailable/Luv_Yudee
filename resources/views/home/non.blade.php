...
{{-- <link href="{{ asset('/assets/css/conract.css') }}" rel="stylesheet" type="text/css" /> --}}
                ...
                <div class="row d-flex align-items-end">
                    <div class="col-lg-5 position-relative">
                        <div class="home8-contact-form default-box-shadow1 bdrs12 bdr1 p30 mb30-md bgc-white">
                            ...
                            <form class="form-style1" action="/conract" method="POST">
                                @csrf

                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb20"><label class="heading-color ff-heading fw600 mb10">First
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb20"><label class="heading-color ff-heading fw600 mb10">Last
                                                Name</label><input type="text" class="form-control"
                                                placeholder="Your Name" name="last-name"></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb20"><label
                                                class="heading-color ff-heading fw600 mb10">Email</label><input
                                                type="email" class="form-control" placeholder="Your Name"
                                                name="email"></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb10"><label
                                                class="heading-color ff-heading fw600 mb10">Textarea</label>
                                            <textarea cols="30" rows="4" placeholder="There are many variations of passages." name="textarea"></textarea>
        ...
        <section class="pt0 pb90 pb10-md">
            <div class="container">
                ...
                <div class="row aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="iconbox-style8 text-center">
                            <div class="icon"><img src="https://static.thenounproject.com/png/164722-200.png"
                                    width="40%" height="50%">
                            </div>
                            <div class="iconbox-content">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="iconbox-style8 text-center">
                            <div class="icon"> <img
                                    src="https://cdn3.iconfinder.com/data/icons/famous-city-skyline/48/Sed-12-512.png"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5 col-xl-6 aos-init aos-animate" data-aos="fade-left">
                            <div class="cta-btns-style1 d-block d-sm-flex align-items-center justify-content-lg-end">
                                ...
                                <a class="ud-btn btn-transparent mr30 mr0-xs" href="/conract"
                                    onclick="scrollToTop()"> Contact Us <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                                </a>
